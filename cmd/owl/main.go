...
func initConfig() {
	...
	unit.SetDrivers(unitDriver, realmDriver, credentialsDriver, policyDriver)
	list.SetDrivers(realmDriver, credentialsDriver, policyDriver, unitDriver, userDriver, groupDriver)
	get.SetDrivers(realmDriver, credentialsDriver, policyDriver, unitDriver, userDriver, groupDriver)
	create.SetDrivers(realmDriver, credentialsDriver, policyDriver, unitDriver, userDriver, groupDriver)
	apply.SetDrivers(realmDriver, credentialsDriver, policyDriver, unitDriver, userDriver, groupDriver)
	update.SetDrivers(realmDriver, credentialsDriver, policyDriver, unitDriver, userDriver, groupDriver)
	upsert.SetDrivers(realmDriver, credentialsDriver, policyDriver, unitDriver, userDriver, groupDriver)
	append.SetDrivers(realmDriver, credentialsDriver, policyDriver, unitDriver, userDriver, groupDriver)
	remove.SetDrivers(realmDriver, credentialsDriver, policyDriver, unitDriver, userDriver, groupDriver)
	delete.SetDrivers(realmDriver, credentialsDriver, policyDriver, unitDriver, userDriver, groupDriver)
	password.SetDrivers(passwordDriver, unitDriver, realmDriver, credentialsDriver, policyDriver)
